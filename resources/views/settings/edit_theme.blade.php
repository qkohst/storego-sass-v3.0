    ...
    <div class="mt-4">
        <div class="card">
            <ul class="nav nav-tabs nav-overflow profile-tab-list" role="tablist">
                @if(Auth::user()->type == 'Owner')
                    <li class="nav-item ml-4">
                        <a href="#store_theme_setting" id="store_setting_tab" class="nav-link active" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true">
            ...
            <div class="tab-content">
                @if(Auth::user()->type == 'Owner')
                    <div class="tab-pane fade show active" id="store_theme_setting" role="tabpanel" aria-labelledby="orders-tab">
                        <div class="card-body">
                                ...
                                @if($theme == 'theme1')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-1" data-toggle="collapse" role="button" data-target="#collapse-2-1" aria-expanded="false" aria-controls="collapse-2-1">
                                            <h6 class="mb-0"><i class="fas fa-cogs mr-3"></i>{{__('Top Bar Setting')}}</h6>
                                        </div>
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_top_bar']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_top_bar" id="enable_top_bar" {{ $getStoreThemeSetting['enable_top_bar'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_top_bar" id="enable_top_bar">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_top_bar">{{__('Enable Header Img')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('top_bar_title',__('Top Bar Title'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('top_bar_number',__('Top Bar Number'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('top_bar_whatsapp',__('Whatsapp'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('top_bar_instagram',__('Instagram'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('top_bar_twitter',__('Twitter'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('top_bar_messenger',__('Messenger'),array('class'=>'form-control-label')) }}
                                ...
                                @if($theme == 'theme3'|| $theme == 'theme4')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-10" data-toggle="collapse" role="button" data-target="#collapse-2-10" aria-expanded="false" aria-controls="collapse-2-10">
                                            <h6 class="mb-0"><i class="fas fa-cogs mr-3"></i>{{__('Banner Img Setting')}}</h6>
                                        </div>
                                        <div id="collapse-2-10" class="collapse" aria-labelledby="heading-2-10" data-parent="#accordion-2">
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_banner_img']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_banner_img" id="enable_banner_img" {{ $getStoreThemeSetting['enable_banner_img'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_banner_img" id="enable_banner_img">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_banner_img">{{__('Enable Banner Img')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="logo" class="form-control-label">{{ __('Banner Image') }}</label>
                                                            <input type="file" name="banner_img" id="banner_img" class="custom-input-file" value="{{!empty($getStoreThemeSetting['banner_img'])?$getStoreThemeSetting['banner_img']:''}}">
                                ...
                                @if($theme == 'theme1'|| $theme == 'theme2'|| $theme == 'theme4' || $theme == 'theme5')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-2" data-toggle="collapse" role="button" data-target="#collapse-2-2" aria-expanded="false" aria-controls="collapse-2-2">
                                            <h6 class="mb-0"><i class="fas fa-cogs mr-3"></i>{{__('Header Setting')}}</h6>
                                        </div>
                                        <div id="collapse-2-2" class="collapse" aria-labelledby="heading-2-2" data-parent="#accordion-2">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6 py-2">
                                                        <h5 class="h5 mb-0">{{__('Header Setting')}}</h5>
                                                        <small> {{__('Note: This detail will use to change header setting.')}}</small>
                                                    </div>
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            ...
                                                            @if(isset($getStoreThemeSetting['enable_header_img']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_header_img" id="enable_header_img" {{ $getStoreThemeSetting['enable_header_img'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_header_img" id="enable_header_img">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_header_img">{{__('Enable Header Img')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" name="header_img" id="header_img" class="custom-input-file" value="{{!empty($getStoreThemeSetting['header_img'])?$getStoreThemeSetting['header_img']:''}}">
                                ...
                                @if($theme == 'theme1' || $theme == 'theme2'|| $theme == 'theme4' || $theme == 'theme3' || $theme == 'theme5')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-3" data-toggle="collapse" role="button" data-target="#collapse-2-3" aria-expanded="false" aria-controls="collapse-2-3">
                                            <h6 class="mb-0"><i class="fas fa-cogs mr-3"></i>{{__('Features Setting')}}</h6>
                                        </div>
                                        <div id="collapse-2-3" class="collapse" aria-labelledby="heading-2-3" data-parent="#accordion-2">
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_features']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_features" id="enable_features" {{ $getStoreThemeSetting['enable_features'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_features" id="enable_features">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_features">{{__('Enable Features')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                ...
                                                <div class="row border-bottom py-4 ">
                                                    <div class="col-12 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_features1']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_features1" id="enable_features1" {{ $getStoreThemeSetting['enable_features1'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_features1" id="enable_features1">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_features1">{{__('Enable Features 1')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('features_icon1',__('Features Font Icon 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('features_title1',__('Features Title 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            {{Form::label('features_description1',__('Features Description 1'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row border-bottom py-4 ">
                                                    <div class="col-12 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_features2']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_features2" id="enable_features2" {{ $getStoreThemeSetting['enable_features2'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_features2" id="enable_features2">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_features2">{{__('Enable Features 2')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('features_icon2',__('Features Font Icon 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('features_title2',__('Features Title 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            {{Form::label('features_description2',__('Features Description 2'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row border-bottom py-4 ">
                                                    <div class="col-12 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_features3']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_features3" id="enable_features3" {{ $getStoreThemeSetting['enable_features3'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_features3" id="enable_features3">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_features3">{{__('Enable Features 3')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('features_icon3',__('Features Font Icon 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            {{Form::label('features_title3',__('Features Title 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            {{Form::label('features_description3',__('Features Description 3'),array('class'=>'form-control-label')) }}
                                ...
                                @if($theme == 'theme1' || $theme == 'theme2'|| $theme == 'theme4' || $theme == 'theme5')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-4" data-toggle="collapse" role="button" data-target="#collapse-2-4" aria-expanded="false" aria-controls="collapse-2-4">
                                            <h6 class="mb-0"><i class="fas fa-cogs mr-3"></i>{{__('Email Subscriber Setting')}}</h6>
                                        </div>
                                        <div id="collapse-2-4" class="collapse" aria-labelledby="heading-2-4" data-parent="#accordion-2">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6 py-2">
                                                        <h5 class="h5 mb-0">{{__('Email Subscriber Setting')}}</h5>
                                                        <small> {{__('Note: This detail will use to change header setting.')}}</small>
                                                    </div>
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_email_subscriber']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_email_subscriber" id="enable_email_subscriber" {{ $getStoreThemeSetting['enable_email_subscriber'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_email_subscriber" id="enable_email_subscriber">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_email_subscriber">{{__('Enable Email Subscriber')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                @if(!empty($getStoreThemeSetting['subscriber_img']))
                                                                    <input type="file" name="subscriber_img" id="subscriber_img" class="custom-input-file" value="{{$getStoreThemeSetting['subscriber_img']}}">
                                                                @else
                                                                    <input type="file" name="subscriber_img" id="subscriber_img" class="custom-input-file" value="">
                                                                @endif

                                                                <label for="subscriber_img">
                                                                    <i class="fa fa-upload"></i>
                                                                    <span>{{__('Choose a file')}}</span>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('subscriber_sub_title',__('Subscriber Sub Title'),array('class'=>'form-control-label')) }}
                                    ...
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-7" data-toggle="collapse" role="button" data-target="#collapse-2-7" aria-expanded="false" aria-controls="collapse-2-7">
                                            <h6 class="mb-0 d-inline-block">
                                                <i class="fas fa-cogs mr-3"></i>{{__('Categories')}}
                                            </h6>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6 py-2">
                                                        ...
                                                        <small> {{__('Note : This detail will use for make explore social media.')}}</small><br>
                                                    </div>
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            <input type="hidden" name="enable_categories" value="off">
                                                            @if(!empty($getStoreThemeSetting['enable_categories']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_categories" id="enable_categories" {{ $getStoreThemeSetting['enable_categories'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_categories" id="enable_categories">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_categories">{{__('Enable Categories')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                @if($theme != 'theme5')
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                {{Form::label('categories',__('Categories'),array('class'=>'form-control-label')) }}
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                {{Form::label('categories_title',__('Categories Title'),array('class'=>'form-control-label')) }}
                                ...
                                @if($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme3'|| $theme == 'theme4' || $theme == 'theme5')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-8" data-toggle="collapse" role="button" data-target="#collapse-2-8" aria-expanded="false" aria-controls="collapse-2-8">
                                            <h6 class="mb-0 d-inline-block">
                                                <i class="fas fa-cogs mr-3"></i>{{__('Testimonials')}}
                                            </h6>
                                        </div>
                                        <div id="collapse-2-8" class="collapse" aria-labelledby="heading-2-8" data-parent="#accordion-2">
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_testimonial']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial" id="enable_testimonial" {{ $getStoreThemeSetting['enable_testimonial'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial" id="enable_testimonial">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_testimonial">{{__('Enable Testimonials')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_main_heading',__('Main Heading'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_main_heading_title',__('Main Heading Title'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row border-bottom border-top py-2">
                                                    <div class="col-12 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_testimonial1']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial1" id="enable_testimonial1" {{ $getStoreThemeSetting['enable_testimonial1'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial1" id="enable_testimonial1">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_testimonial1">{{__('Enable Testimonial 1')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="testimonial_img1" class="form-control-label">{{__('Image')}}</label>
                                                            <input type="file" class="form-control-file" name="testimonial_img1" value=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_name1',__('Name'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_about_us1',__('About Us'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_description1',__('Description'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row border-bottom py-2">
                                                    <div class="col-12 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_testimonial2']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial2" id="enable_testimonial2" {{ $getStoreThemeSetting['enable_testimonial2'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial2" id="enable_testimonial2">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_testimonial2">{{__('Enable Testimonial 2')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="testimonial_img2" class="form-control-label">{{__('Image')}}</label>
                                                            <input type="file" class="form-control-file" name="testimonial_img2" value=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_name2',__('Name'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_about_us2',__('About Us'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_description2',__('Description'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row border-bottom py-2">
                                                    <div class="col-12 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_testimonial3']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial3" id="enable_testimonial3" {{ $getStoreThemeSetting['enable_testimonial3'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_testimonial3" id="enable_testimonial3">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_testimonial3">{{__('Enable Testimonial 3')}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="testimonial_img3" class="form-control-label">{{__('Image')}}</label>
                                                            <input type="file" class="form-control-file" name="testimonial_img3" value=""/>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_name3',__('Name'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_about_us3',__('About Us'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('testimonial_description3',__('Description'),array('class'=>'form-control-label')) }}
                                ...
                                @if($theme == 'theme1' || $theme == 'theme2'|| $theme == 'theme4' || $theme == 'theme5')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-9" data-toggle="collapse" role="button" data-target="#collapse-2-9" aria-expanded="false" aria-controls="collapse-2-9">
                                            <h6 class="mb-0 d-inline-block">
                                                <i class="fas fa-cogs mr-3"></i>{{__('Brand Logo')}}
                                            </h6>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_brand_logo']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_brand_logo" id="enable_brand_logo" {{ $getStoreThemeSetting['enable_brand_logo'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_brand_logo" id="enable_brand_logo">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_brand_logo">{{__('Enable Brand Logo')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="file" class="form-control-label">{{__('Brand Logo')}}</label>
                                ...
                                @if($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme5')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-5" data-toggle="collapse" role="button" data-target="#collapse-2-5" aria-expanded="false" aria-controls="collapse-2-5">
                                            <h6 class="mb-0 d-inline-block">
                                                <i class="fas fa-cogs mr-3"></i>{{__('Footer 1')}}
                                            </h6>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_footer_note']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_footer_note" id="enable_footer_note" {{ $getStoreThemeSetting['enable_footer_note'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_footer_note" id="enable_footer_note">
                                                            @endif
                                                            <label class="custom-control-label form-control-label" for="enable_footer_note">{{__('Enable Footer Note')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
                                                <div class="row">
                                                    ...
                                                    @if($theme == 'theme2')
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                {{Form::label('footer_number',__('Footer Number'),array('class'=>'form-control-label')) }}
                                                                {{Form::text('footer_number',null,array('class'=>'form-control','placeholder'=>'Enter Footer Number'))}}
                                                            </div>
                                                            @error('footer_number')
                                                ...
                                                {{--Foorer link 1--}}
                                                <div class="custom-control custom-switch text-right quick_link_center">
                                                    <input type="hidden" name="enable_quick_link1" value="off">
                                                    @if(!empty($getStoreThemeSetting['enable_quick_link1']))
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link1" id="enable_quick_link1" {{ $getStoreThemeSetting['enable_quick_link1'] == 'on' ? 'checked="checked"' : '' }}>
                                                    @else
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link1" id="enable_quick_link1">
                                                    @endif
                                                    <label class="custom-control-label form-control-label" for="enable_quick_link1">{{__('Enable Quick Link 1')}}</label>

                                                </div>
                                                <div class="form-group">
                                                    {{Form::label('quick_link_header_name1',__('Footer Quick Link Header Name 1'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name1',__('Quick Link Name 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url1',__('Quick Link Url 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name12',__('Quick Link Name 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url12',__('Quick Link Url 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name13',__('Quick Link Name 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url13',__('Quick Link Url 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name14',__('Quick Link Name 4'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url14',__('Quick Link Url 4'),array('class'=>'form-control-label')) }}
                                                ...
                                                <hr class="horizontal-rule text-primary">

                                                {{--Foorer link 2--}}
                                                <div class="custom-control custom-switch text-right quick_link_center">
                                                    <input type="hidden" name="enable_quick_link2" value="off">
                                                    @if(!empty($getStoreThemeSetting['enable_quick_link2']))
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link2" id="enable_quick_link2" {{ $getStoreThemeSetting['enable_quick_link2'] == 'on' ? 'checked="checked"' : '' }}>
                                                    @else
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link2" id="enable_quick_link2">
                                                    @endif
                                                    <label class="custom-control-label form-control-label" for="enable_quick_link2">{{__('Enable Quick Link 2')}}</label>
                                                </div>
                                                <div class="form-group">
                                                    {{Form::label('quick_link_header_name2',__('Footer Quick Link Header Name 2'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name21',__('Quick Link Name 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url21',__('Quick Link Url 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name22',__('Quick Link Name 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url22',__('Quick Link Url 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name23',__('Quick Link Name 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url23',__('Quick Link Url 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name24',__('Quick Link Name 4'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url24',__('Quick Link Url 4'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="custom-control custom-switch text-right quick_link_center">
                                                    ...
                                                    @if(!empty($getStoreThemeSetting['enable_quick_link3']))
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link3" id="enable_quick_link3" {{ $getStoreThemeSetting['enable_quick_link3'] == 'on' ? 'checked="checked"' : '' }}>
                                                    @else
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link3" id="enable_quick_link3">
                                                    @endif
                                                    <label class="custom-control-label form-control-label" for="enable_quick_link3">{{__('Enable Quick Link 3')}}</label>

                                                </div>
                                                <div class="form-group">
                                                    {{Form::label('quick_link_header_name3',__('Footer Quick Link Header Name 3'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name31',__('Quick Link Name 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url31',__('Quick Link Url 1'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name32',__('Quick Link Name 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url32',__('Quick Link Name 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name33',__('Quick Link Name 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url33',__('Quick Link Url 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name34',__('Quick Link Name 4'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url34',__('Quick Link Url 4'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="custom-control custom-switch text-right quick_link_center">
                                                    ...
                                                    @if(!empty($getStoreThemeSetting['enable_quick_link4']))
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link4" id="enable_quick_link4" {{ $getStoreThemeSetting['enable_quick_link4'] == 'on' ? 'checked="checked"' : '' }}>
                                                    @else
                                                        <input type="checkbox" class="custom-control-input" name="enable_quick_link4" id="enable_quick_link4">
                                                    @endif
                                                    <label class="custom-control-label form-control-label" for="enable_quick_link4">{{__('Enable Quick Link 4')}}</label>

                                                </div>
                                                <div class="form-group">
                                                    {{Form::label('quick_link_header_name4',__('Footer Quick Link Header Name 4'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name41',__('Quick Link Name 4'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url41',__('Quick Link Url 4'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name42',__('Quick Link Name 4'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url42',__('Quick Link Url 4'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    @if($theme != 'theme5')
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                {{Form::label('quick_link_name43',__('Quick Link Name 4'),array('class'=>'form-control-label')) }}
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                {{Form::label('quick_link_url43',__('Quick Link Url 4'),array('class'=>'form-control-label')) }}
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                {{Form::label('quick_link_name44',__('Quick Link Name 4'),array('class'=>'form-control-label')) }}
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                {{Form::label('quick_link_url44',__('Quick Link Url 4'),array('class'=>'form-control-label')) }}
                                        ...
                                        <div id="collapse-2-5" class="collapse" aria-labelledby="heading-2-5" data-parent="#accordion-2">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name21',__('Quick Link Name 2'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url21',__('Quick Link Url 2'),array('class'=>'form-control-label')) }}
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_name31',__('Quick Link Name 3'),array('class'=>'form-control-label')) }}
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            {{Form::label('quick_link_url31',__('Quick Link Url 3'),array('class'=>'form-control-label')) }}
                                ...
                                @if($theme == 'theme1' || $theme == 'theme2' || $theme == 'theme3'|| $theme == 'theme4' || $theme == 'theme5')
                                    <div class="card">
                                        <div class="card-header py-4" id="heading-2-6" data-toggle="collapse" role="button" data-target="#collapse-2-6" aria-expanded="false" aria-controls="collapse-2-6">
                                            <h6 class="mb-0 d-inline-block">
                                                <i class="fas fa-cogs mr-3"></i>{{__('Footer 2')}}
                                            </h6>
                                        </div>
                                                    ...
                                                    <div class="col-6 py-2 text-right">
                                                        <div class="custom-control custom-switch p-0">
                                                            ...
                                                            @if(!empty($getStoreThemeSetting['enable_footer']))
                                                                <input type="checkbox" class="custom-control-input" name="enable_footer" id="enable_footer" {{ $getStoreThemeSetting['enable_footer'] == 'on' ? 'checked="checked"' : '' }}>
                                                            @else
                                                                <input type="checkbox" class="custom-control-input" name="enable_footer" id="enable_footer">
                                                            @endif

                                                            <label class="custom-control-label form-control-label" for="enable_footer">{{__('Enable Footer')}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="footer_hr">
