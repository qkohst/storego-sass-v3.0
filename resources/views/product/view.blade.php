                ...
                <div class="card-body">
                    @if(!empty($product->is_cover))
                        <a href="{{asset(Storage::url('uploads/is_cover_image/'.$product->is_cover))}}" data-fancybox="product">
                            <img alt="Image placeholder" src="{{asset(Storage::url('uploads/is_cover_image/'.$product->is_cover))}}" class="img-center pro_max_width1">
                        </a>
                    @else
                        <a href="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}" data-fancybox="product">
                            <img alt="Image placeholder" src="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}" class="img-center pro_max_width1">
                        </a>
                    @endif
                    <div class="row mt-4">
