                ...
                <div class="card ">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 proprice">
                                <div class="form-group">
                                    {{Form::label('last_price',__('Last Price'),array('class'=>'form-control-label')) }}
                                    {!! Form::text('last_price',null,array('class'=>'form-control','placeholder'=>__('Enter Last Price'))) !!}
                                </div>
                            </div>
                            <div class="col-6 proprice">
                                <div class="form-group">
                            ...
                            <div class="col-12 pt-4">
                                <div class="form-group">
                                    {{Form::label('specification',__('Product Specification'),array('class'=>'form-control-label')) }}
                                    {{Form::textarea('specification',null,array('class'=>'form-control summernote-simple','rows'=>3,'placeholder'=>__('Product Specification')))}}
                                </div>
                            </div>
                            <div class="col-12 pt-4">
                                <div class="form-group">
                                    {{Form::label('detail',__('Product Details'),array('class'=>'form-control-label')) }}
                                    {{Form::textarea('detail',null,array('class'=>'form-control summernote-simple','rows'=>3,'placeholder'=>__('Product Details')))}}
                                </div>
                            </div>
                        </div>
