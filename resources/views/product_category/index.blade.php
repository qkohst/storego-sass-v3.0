                                    ...
                                    <div class="media align-items-center">
                                        <div>
                                            @if($product_category->categorie_img)
                                                <img alt="Image placeholder" src="{{$store_logo}}/{{$product_category->categorie_img}}" class="rounded-circle" style="width: 80px; height: 80px;">
                                            @else
                                                <img alt="Image placeholder" src="{{$store_logo}}/default.jpg" class="rounded-circle" style="width: 100px; height: 80px;">
                                            @endif
                                        </div>
                                    </div>
                                </td>
