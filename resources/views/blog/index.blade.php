                            ...
                            <tr data-name="{{$blog->title}}">
                                <td scope="row">
                                    <div class="media align-items-center">
                                        <div>
                                            <img alt="Image placeholder" src="{{$store_logo}}/{{$blog->blog_cover_image}}" class="rounded-circle" style="width: 80px; height: 80px;">
                                        </div>
                                    </div>
                                </td>
                                <td class="sorting_1">{{$blog->title}}</td>
                                <td class="sorting_1">{{\App\Models\Utility::dateFormat($blog->created_at)}}</td>
