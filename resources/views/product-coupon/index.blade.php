...
@section('action-btn')
    <a href="#" data-size="lg" data-url="{{route('product-coupon.create')}}" data-ajax-popup="true" data-title="{{__('Add Coupon')}}" class="btn btn-sm btn-white bor-radius">
     ...
     <a href="{{route('productcoupon.export')}}" class="btn btn-sm btn-white bor-radius ml-4">
        <i class="fa fa-file-excel"></i> {{__('Export')}}
    </a>
    <a href="#" class="btn btn-sm btn-white bor-radius ml-4" data-url="{{ route('productcoupon.file.import') }}" data-ajax-popup="true" data-title="{{__('Import customer CSV file')}}">
