                    ...
                    <div data-toggle="sticky" data-sticky-offset="30">
                        <div class="card" id="card-summary">
                            <div class="card-header b-0 py-3">
                                <div class="row align-items-center">
                                    <h3 class="ml-3 playfair text-primary store-title-medium t-secondary"mb-0 text-white t-title>{{__('Summary')}}</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                @if(!empty($products))
                                        ...
                                        @if(isset($product['variant_id']) && !empty($product['variant_id']))
                                            <div class="row mb-2 pb-2 delimiter-bottom">
                                                ...
                                                <div class="col-4 text-right lh-100">
                                                    <small class="text-white font-weight-bold">{{__('Price')}}</small>
                                            ...
                                            <div class="row mb-2 pb-2 delimiter-bottom">
                                                <div class="col-8">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <div class="sum-title lh-100">
                                                                <small class="mb-0 text-white t-title">{{$product['product_name']}}</small>
                                                            </div>
                                                            @php
                                                                $total_tax=0;
                                                            @endphp
                                                            <small class="text-muted s-dim text-white">
                                                ...
                                                <div class="col-4 text-right lh-100">
                                                    <small class="text-muted s-dim text-white">{{__('Price')}}</small>
                                                    <p class="text-muted s-dim text-primary s-rate font-weight-bold">
                                                        @php
                            ...
                            <div class="card-body bg-primary">
                                <!-- Tax -->
                                    <div class="row mt-2 pt-2 p-2 border-top bg-primary">
                                        <div class="col-7 text-right">
                                            <small class="text-dark">{{ __('Subtotal (Before Tax)')}} :</small>
                                        </div>
                                        <div class="col-5 text-right">
                                            <span class="text-sm  t-black15 text-dark">{{\App\Models\Utility::priceFormat(!empty($sub_total)?$sub_total:0)}}</span>
                                        </div>
                                    </div>
                                ...
                                <!-- Coupon -->
                                    <div class="row mt-2 pt-2 p-2 border-top">
                                        <div class="col-7 text-right">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <div class="text-limit lh-100 text-dark">
                                                        <small class=" mb-0">{{__('Coupon')}} :</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-5 text-right text-dark">
                                            <span class="text-sm dicount_price">{{\App\Models\Utility::priceFormat(0)}}</span>
                                        </div>
                                    </div>
                                ...
                                <!-- Final total -->
                                    <div class="row mt-2 pt-2 border-top">
                                        ...
                                        <div class="col-7 text-right">
                                            <small class="text-uppercase font-weight-bold text-dark">{{__('Total')}} :</small>
                                        </div>
                                        <div class="col-5 text-right final_total_price">
                                            <span class="text-sm font-weight-bold s-p-total pro_total_price text-dark" data-original="{{\App\Models\Utility::priceFormat(!empty($total)?$total:0)}}"> {{\App\Models\Utility::priceFormat(!empty($total)?$total:'0')}}</span>
                                        </div>
                                    </div>
                                @endif
                            </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.is_success) {
                            ...
                            var html = '';
                            html += '<span class="text-sm font-weight-bold s-p-total pro_total_price text-dark" data-original="' + data.final_price_data_value + '">' + data.final_price + '</span>'
