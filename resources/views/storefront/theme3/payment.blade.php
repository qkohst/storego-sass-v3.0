                            ...
                            <div class="card" id="card-summary">
                                <div class="card-header py-3 border-bottom-0">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <span class="playfair text-primary store-title-medium t-secondary">{{__('Summary')}}</span>
                                        </div>
                                                        ...
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                @php
                                                                    $total_tax=0;
                                                                @endphp
                                                                <small class="text-primary">{{$product['quantity']}} x {{\App\Models\Utility::priceFormat($product['variant_price'])}}
                                                ...
                                                <div class="row mb-2 pb-2 delimiter-bottom">
                                                    <div class="col-8">
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="text-limit lh-100">
                                                                    <small class="font-weight-bold mb-0 text-primary">{{$product['product_name']}}</small>
                                                                </div>
                                                                @php
                                                                    $total_tax=0;
                                                                @endphp
                                                                <small class="text-primary">{{$product['quantity']}} x {{\App\Models\Utility::priceFormat($product['price'])}}
                                                                    @if(!empty($product['tax']))
                                                                        +
                                                                        @foreach($product['tax'] as $tax)
                                                                            @php
