                        ...
                        <div class="card-body">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-6 order-md-1">
                                    <a href="{{route('user-address.useraddress',$store->slug)}}" class="btn bg-primary btn-icon  hover-translate-y-n3">
                                        <span class="btn-inner--text t-secondary">{{__('Proceed to checkout')}}</span>
