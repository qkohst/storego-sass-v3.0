            ...
            <div class="row row-grid">
                <div class="col-xl-8 col-lg-7">
                    ...
                    <div class="mt-4 text-right">
                        <a href="{{route('store.slug',$store->slug)}}" class="btn btn-link text-sm text-primary font-weight-bold ">{{__('Return to shop')}}</a>
                    ...
                    <div data-toggle="sticky" data-sticky-offset="30">
                        <div class="card" id="card-summary">
                            <div class="card-header b-0 py-3">
                                <div class="row align-items-center">
                                    <h3 class="ml-3 playfair text-primary store-title-medium t-secondary">{{__('Summary')}}</h3>
                                </div>
                            </div>
                                        ...
                                        @if(isset($product['variant_id']) && !empty($product['variant_id']))
                                            <div class="row mb-2 pb-2 delimiter-bottom">
                                                    ...
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <div class="sum-title lh-100">
                                                                <small class="font-weight-bold mb-0 text-primary">{{$product['product_name'].' - ( ' . $product['variant_name'] .' ) '}}</small>
                                                            </div>
                                                            @php
                                                                $total_tax=0;
                                                            @endphp
                                                ...
                                                <div class="col-4 text-right lh-100">
                                                    <small class="text-primary font-weight-bold">{{__('Price')}}</small>
                                ...
                                <!-- Tax -->
                                    <div class="row mt-2 pt-2 p-2 border-top ">
                                        <div class="col-7 text-right">
                                            <small class="font-weight-bold TTNorms">{{ __('Subtotal (Before Tax)')}} :</small>
                                        </div>
                                    ...
                                    <div class="row mt-2 pt-2 p-2 border-top">
                                        <div class="col-7 text-right">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <div class="text-limit lh-100">
                                                        <small class=" font-weight-bold TTNorms">{{__('Coupon')}} :</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
