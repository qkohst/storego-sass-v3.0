                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <button href="#" class="btn btn-white btn-white btn-icon rounded-pill hover-translate-y-n3 mt-4" id="pro_scroll">
                            <span class="btn-inner--text">{{!empty($storethemesetting->button_text)?$storethemesetting->button_text:'Start shopping'}}</span>
                        ...
                        @foreach(explode(',',$storethemesetting['brand_logo']) as $k => $value)
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                <a href="#">
                                    ...
                                    @else
                                        <img src="{{asset(Storage::url('uploads/logo/brand_logo.png'))}}" alt="Footer logo">
                                    @endif
                                </a>
                            </div>
                        @endforeach
