                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary btn-icon shadow hover-shadow-lg hover-translate-y-n3" id="pro_scroll">
                                            <span class="btn-inner--text t-secondary">{{__('Show more products')}}</span>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 cat-main-boxes">
                            <div class="categories-content">
                                ...
                                <p class="t-l-gray mt-3 mb-5 w-75">{{!empty($storethemesetting['categories_title'])?$storethemesetting['categories_title']:'There is only that moment and the incredible certainty that everything under the sun has been written by one hand only.'}}</p>
                            </div>
                        ...
                        @foreach(explode(',',$storethemesetting['brand_logo']) as $k => $value)
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                <a href="#">
                                    ...
                                    @else
                                        <img src="{{asset(Storage::url('uploads/logo/logo.png'))}}" alt="Footer logo">
                                    @endif
                                </a>
                            </div>
                        @endforeach
