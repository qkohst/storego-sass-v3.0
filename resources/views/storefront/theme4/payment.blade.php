                ...
                <div class="row row-grid mb-5">
                            ...
                            <div class="card payment-card">
                                <div class="box-space">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg col-md-4 text-right truck-icon">
                    ...
                    <!-- Add money using whatsapp -->
                        @if($store['enable_whatsapp'] == 'on')
                            <div class="card payment-card radius-100-50">
                                <div class="box-space">
                                    <div class="card-strip radius-110">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12 text-right">
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST" action="{{ route('user.bank_transfer',$store->slug) }}">
                                                ...
                                                <input type="hidden" name="product_id">
                                                <div class="form-group mt-3">
                                                    <button type="button" class="btn btn-primary btn-sm" id="bank_transfer">{{__('Pay Now')}}</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div data-toggle="sticky" data-sticky-offset="30">
                            <div class="card round-card" id="card-summary">
                                                        ...
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                @php
                                                                    $total_tax=0;
                                                                @endphp
                                                                <small class="text-muted">{{$product['quantity']}} x {{\App\Models\Utility::priceFormat($product['variant_price'])}}
                                                        ...
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                @php
                                                                    $total_tax=0;
                                                                @endphp
                                                                <small class="text-muted">{{$product['quantity']}} x {{\App\Models\Utility::priceFormat($product['price'])}}
                                                                    @if(!empty($product['tax']))
                                                                        @foreach($product['tax'] as $tax)
                                                                            @php
                                ...
                                <div class="card-body b-bottom">
                                    ...
                                    <div class="row mt-2 pt-2">
                                        ...
                                        <div class="col-4 text-right">
                                            <span class="text-sm font-weight-bold"> {{\App\Models\Utility::priceFormat(!empty($sub_total)?$sub_total:0)}}</span>
                                    ...
                                    @foreach($taxArr['tax'] as $k=>$tax)
                                        <div class="row mt-2 pt-2 border-top">
                                            ...
                                            <div class="col-4 text-right">
                                                <span class="text-sm font-weight-bold">{{\App\Models\Utility::priceFormat($taxArr['rate'][$k])}}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                <!-- Discount -->
                                    <div class="row mt-2 pt-2 border-top">
                                        ...
                                        <div class="col-4 text-right">
                                            <span class="text-sm font-weight-bold dicount_price">{{!empty($discount_price)?$discount_price:'0.00'}}</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="shipping_price_add">
                                            <div class="row mt-2 pt-2 border-top">
                                                <div class="col-8 text-right pt-2">
                                                    <small class="text-limit lh-100 text-sm">{{__('Shipping Price')}} :</small>
                                                </div>
                                                <div class="col-4 text-right"><span class="text-sm font-weight-bold shipping_price" data-value="{{$shipping_price}}">{{\App\Models\Utility::priceFormat(!empty($shipping_price)?$shipping_price:0)}}</span></div>
                                            </div>
                                        </div>
                                @endif
                                ...
                                <!-- Final total -->
                                    <div class="row mt-2 pt-2 border-top" id="Subtotal">
                                        ...
                                        <div class="col-4 text-right final_total_price">
                                            <span class="text-sm font-weight-bold total_price" data-value="{{$total+$shipping_price-$coupon_price}}"> {{\App\Models\Utility::priceFormat(!empty($total)?$total+$shipping_price-$coupon_price:0)}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
