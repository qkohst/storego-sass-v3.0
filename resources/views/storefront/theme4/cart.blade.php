                    ...
                    <div class="row">
                        <div class="pr-title mb-4">
                            ...
                            <div class="payment-step">
                                <a href="{{route('store.cart',$store->slug)}}" class="btn btn-mycart rounded-pill active">1 - {{__('My Cart')}}</a>
                                <a href="{{route('user-address.useraddress',$store->slug)}}" class="btn btn-mycart rounded-pill">2 - {{__('Customer')}}</a>
                                <a href="{{route('store-payment.payment',$store->slug)}}" class="btn btn-mycart rounded-pill">3 - {{__('Payment')}}</a>
                            </div>
                        </div>
                    </div>
