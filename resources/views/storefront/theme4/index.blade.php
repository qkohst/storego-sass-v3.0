                                ...
                                @if(!empty($storethemesetting['brand_logo']))
                                    @foreach(explode(',',$storethemesetting['brand_logo']) as $k => $value)
                                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                            <a href="#">
                                                @if(!empty($value) && \Storage::exists('uploads/logo/'.$value))
                                                    <img class="logo-imare" src="{{asset(Storage::url('uploads/logo/').(!empty($value)?$value:'storego-image.png'))}}" alt="logo">
                                                @else
                                                    <img class="logo-imare" src="{{asset(Storage::url('uploads/logo/default.png'))}}" alt="logo">
                                                @endif
                                            </a>
                                        </div>
                                    @endforeach
                                            ...
                                            <div class="swiper-slide p-3">
                                                <div class="card bg-transparent">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center">
                                                            <div>
                                                                <img alt="" src="{{asset(Storage::url('uploads/store_logo/'.(!empty($storethemesetting['testimonial_img2'])?$storethemesetting['testimonial_img1']:'qo.png')))}}" class="avatar rounded-circle">
                                                            </div>
                                                            <div class="pl-3">
                                            ...
                                            <div class="swiper-slide p-3">
                                                <div class="card bg-transparent">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center">
                                                            <div>
                                                                <img alt="" src="{{asset(Storage::url('uploads/store_logo/'.(!empty($storethemesetting['testimonial_img3'])?$storethemesetting['testimonial_img1']:'qo.png')))}}" class="avatar rounded-circle">
                                                            </div>
                                                            <div class="pl-3">
