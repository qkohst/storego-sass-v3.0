...
<header class="header home-hader" id="header-main">
    <!-- Main navbar -->
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent {{(Request::segment(3) != '')?'bg-primary':''}}{{(Request::segment(1) == 'page')?'bg-primary':''}}{{(Request::segment(1) == 'store-blog')?'bg-primary':''}}" id="navbar-main">
        <div class="container px-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbar-main-collapse">
                ...
                <ul class="navbar-nav align-items-lg-center ml-lg-auto nav-my-store">
                    ...
                    <li class="nav-item">
                        <a href="{{route('store.categorie.product',[$store->slug,'Start shopping'])}}" class="big-btn bg-white ml-2 rounded-pill hover-translate-y-n3 ">
