...
@endphp
<header class="header {{(Request::segment(3)  != '')?'inner-page':''}}{{(Request::segment(1)  === 'page')?'inner-page':''}}" id="header-main">
    <!-- Main navbar -->
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent" id="navbar-main">
        <div class="container px-lg-0">
            ...
            <a class="navbar-brand mr-lg-5" href="{{route('store.slug',$store->slug)}}">
                @if(route('store.slug'))
                    <img alt="Image placeholder" src="{{asset(Storage::url('uploads/store_logo/logo-2.png'))}}" id="navbar-logo" style="height: 40px;">
                    <img alt="Image placeholder" class="mobile-view" src="{{asset(Storage::url('uploads/store_logo/'.$store->logo))}}" id="navbar-logo">
                @else
                    @if(!empty($store->logo))
                        <img alt="Image placeholder" src="{{asset(Storage::url('uploads/store_logo/'.route('store.slug')?'logo-2.png':$store->logo))}}" id="navbar-logo" style="height: 40px;">
                        <img alt="Image placeholder" class="mobile-view" src="{{asset(Storage::url('uploads/store_logo/'.$store->logo))}}" id="navbar-logo">
                    @else
                        <img alt="Image placeholder" src="{{asset(Storage::url('uploads/store_logo/logo.png'))}}" id="navbar-logo" style="height: 40px;">
                        <img alt="Image placeholder" src="{{asset(Storage::url('uploads/store_logo/logo.png'))}}" class="mobile-view" id="navbar-logo">
                    @endif
                @endif
            </a>
