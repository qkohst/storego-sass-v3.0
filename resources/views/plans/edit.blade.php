...
<div class="row">
    ...
    <div class="col-6">
        <div class="custom-control custom-switch pt-4">
            <input type="checkbox" class="custom-control-input" name="additional_page" id="additional_page" {{ ($plan['additional_page'] == 'on') ? 'checked=checked' : '' }}>
            <label class="custom-control-label form-control-label" for="additional_page">{{__('Enable Additional Page')}}</label>
        </div>
    </div>
    <div class="col-6">
        <div class="custom-control custom-switch pt-4">
            <input type="checkbox" class="custom-control-input" name="blog" id="blog" {{ ($plan['blog'] == 'on') ? 'checked=checked' : '' }}>
            <label class="custom-control-label form-control-label" for="blog">{{__('Enable Blog')}}</label>
        </div>
    </div>
    <div class="col-6">
        <div class="custom-control custom-switch pt-4">
