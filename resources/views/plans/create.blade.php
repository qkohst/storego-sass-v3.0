...
<div class="row">
    ...
    <div class="col-6">
        <div class="custom-control custom-switch pt-2">
            <input type="checkbox" class="custom-control-input" name="additional_page" id="additional_page">
            <label class="custom-control-label form-control-label" for="additional_page">{{__('Enable Additional Page')}}</label>
        </div>
    </div>
    <div class="col-6">
        <div class="custom-control custom-switch pt-2">
            <input type="checkbox" class="custom-control-input" name="blog" id="blog">
